...
const services = [
  {
    ...
    desc: "Зеркальная поверхность визуально увеличивает пространство и добавляет роскоши интерьеру.",
  ...
  },
  {
    ...
    desc: "Мягкий перламутровый блеск создаёт уютную атмосферу и благородный вид помещения.",
    features: ["Перламутровый блеск", "Мягкий свет", "Элегантность"],
  },
  {
    icon: LayoutGrid,
  ...
  },
  {
    ...
    desc: "Уникальные изображения на потолке — от облаков и звёзд до авторских рисунков.",
    features: ["HD-качество", "Любой рисунок", "УФ-стойкость"],
  },
  {
    icon: Lightbulb,
